      ...
      <div className="max-w-2xl mx-auto p-4">
        ...
        <form className="flex flex-col" action="">
          <div className="flex flex-col items-center mt-6">
            <label htmlFor="" className="justify-center text-white text-2xl">
              Title
            </label>
            <input
              type="text"
          ...
          <div className="flex flex-col items-center mt-6">
            <label htmlFor="image" className="justify-center text-white text-2xl">
              Upload Image
            </label>
            <input
            ...
            {imagePreview&&(
              <Image
              src={imagePreview}
              height={50} width={50} alt="Blogimage"
              className="mt-4"/>
            )}
