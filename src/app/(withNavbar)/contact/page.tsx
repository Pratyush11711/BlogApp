...
export default function VortexDemo() {
  ...
  return (
    // <div className="max-w-full mx-auto rounded-md  h-[100vh]  ">
    //   <Vortex
    ...
    >
      ...
      <LabelInputContainer className="mb-4">
        <Label htmlFor="email" className='text-white'>Email Address</Label>
        <Input id="email" placeholder="Enter your email" className='text-black'type="email" name="email"/>
        <ValidationError 
      prefix="Email" 
      field="email"
      errors={state.errors}
    />
      ...
      <LabelInputContainer className="mb-4">
      <Label htmlFor="name" className='text-white'>Name</Label>
        <Input id="name" placeholder="Enter your name" className='text-black' type="name" name="name" />
        <ValidationError 
      prefix="Name" 
      field="name"
      errors={state.errors}
